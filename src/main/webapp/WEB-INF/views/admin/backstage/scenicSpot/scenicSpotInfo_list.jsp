...
<script type="text/javascript" src="${basePath}/static/ttms/product/scenicSpotInfo_list.js"></script>
			...
			<div class="row page-search">
			 <div class="col-md-12">
				<ul class="list-unstyled list-inline">
					<li><input type="text" id="scenicSpotNameId" class="form-control"placeholder="景点名称"></li>
