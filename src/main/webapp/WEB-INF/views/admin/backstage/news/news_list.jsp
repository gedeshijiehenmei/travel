...
<script type="text/javascript" src="${basePath}/static/ttms/product/news_list.js"></script>
			...
			<div class="row page-search">
			 <div class="col-md-12">
				<ul class="list-unstyled list-inline">
					<li><input type="text" id="searchNameId" class="form-control"placeholder="新闻标题"></li>
